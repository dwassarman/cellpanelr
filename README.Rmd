...
- `data_nutlin()` provides an example data set containing cell line sensitivity to the drug nutlin-3. See the example folder for a more detailed analysis of this data set.
